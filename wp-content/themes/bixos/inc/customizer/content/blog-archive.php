...
$wp_customize->add_control( 
    ...
    array (
        ...
        'section'   => 'section_content_blog_archive',
        'priority'  => 2,
        'label'         => esc_html__('Blog Layout', 'bixos'),
        'choices'   => array (
            'blog-list' =>  esc_html__( 'Blog List','bixos' ),                  
            'blog-grid'=> esc_html__( 'Blog Grid','bixos' ),
            )  
    )
);
...
$wp_customize->add_control(
    ...
    array(
        ...
        'section'   => 'section_content_blog_archive',
        'priority'  => 3,
        'label'     => esc_html__('Post Grid Columns', 'bixos'),
        'choices'   => array(
...
$wp_customize->add_control( new themesflat_Control_Drag_And_Drop( $wp_customize,
    ...
    array(
        ...
        'label'     => esc_html__('Post Content Elements', 'bixos'),
        'description' => esc_html__( 'Drag and drop elements to re-order.', 'bixos' ),
        'section'   => 'section_content_blog_archive',
        'priority'  => 5,
        'choices' => array(
            'meta'            => esc_html__( 'Meta', 'bixos' ),
            'title'           => esc_html__( 'Title', 'bixos' ),
            'excerpt_content' => esc_html__( 'Excerpt', 'bixos' ),
            'readmore'        => esc_html__( 'Read More', 'bixos' ),
        ),        
    ))
); 
...
$wp_customize->add_control(
    ...
    array(
        'type'      => 'text',
        'label'     => esc_html__('Read More Text', 'bixos'),
        'section'   => 'section_content_blog_archive',
        'priority'  => 7
    )
);
...
$wp_customize->add_control( new themesflat_Control_Drag_And_Drop( $wp_customize,
    ...
    array(
        'type'      => 'draganddrop-controls',
        'label'     => esc_html__('Meta Elements', 'bixos'),
        'description' => esc_html__( 'Drag and drop elements to re-order.', 'bixos' ),
        'section'   => 'section_content_blog_archive',
        'priority'  => 8,
        'choices' => array(
            ...
            'category'  => esc_html__( 'Category', 'bixos' ),
            'comment'   => esc_html__( 'Comment', 'bixos' ),
        ),        
    ))
); 
...
$wp_customize->add_control( 
    ...
    array(
        ...
        'section'   => 'section_content_blog_archive',
        'priority'  => 9,
        'label'         => esc_html__('Pagination Style', 'bixos'),
        'choices'   => array(
            'pager'     => esc_html__('Pager','bixos'),
            'numeric'         =>  esc_html__('Numeric','bixos'),
            'pager-numeric'         =>  esc_html__('Pager & Numeric','bixos'),
            'loadmore' =>  esc_html__( 'Load More', 'bixos' )
        ),
    )
);