...
$wp_customize->add_control(
    ...
    array(
        'type'      => 'text',
        'label'     => esc_html__('Customize Blog Featured Title', 'bixos'),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type'      => 'checkbox',
        'label'     => esc_html__('Post Navigator ( OFF | ON )', 'bixos'),
        'section'   => 'section_content_blog_single',
        'priority'  => 2
    ))
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Entry Footer ( OFF | ON )', 'bixos'),
        'section' => 'section_content_blog_single',
        'priority' => 3,
    ))
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type'      => 'checkbox',
        'label'     => esc_html__('Related Posts ( OFF | ON )', 'bixos'),
        'section'   => 'section_content_blog_single',
        'priority'  => 4
    ))
);
...
$wp_customize->add_control( 
    ...
    array(
        ...
        'section'   => 'section_content_blog_single',
        'priority'  => 5,
        'label'         => esc_html__('Related Posts Style', 'bixos'),
        'choices'   => array(
...
$wp_customize->add_control(
    ...
    array(
        ...
        'section'   => 'section_content_blog_single',
        'priority'  => 6,
        'label'     => esc_html__('Columns Of Related Posts', 'bixos'),
        'choices'   => array(                
