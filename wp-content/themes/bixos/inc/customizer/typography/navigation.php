...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_color',
        array(
            'label' => esc_html__('Regular', 'bixos'),
            'section' => 'section_typo_navigation',
            'priority' => 4
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'mainnav_hover_color',
        array(
            'label' => esc_html__('Hover & Active', 'bixos'),
            'section' => 'section_typo_navigation',
            'priority' => 5
        )
    )
...
$wp_customize->add_control( new themesflat_Info( $wp_customize, 'sub_menu_fonts', array(
    'label' => esc_html__('Sub Menu', 'bixos'),
    'section' => 'section_typo_navigation',
    'settings' => 'themesflat_options[info]',
    'priority' => 20
    ) )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_background_hover',
        array(
            'label' => esc_html__('Background Hover & Active', 'bixos'),
            'section' => 'section_typo_navigation',
            'priority' => 26
        )
    )
...
$wp_customize->add_control(
    new themesflat_ColorOverlay(
        ...
        'sub_nav_border_color',
        array(
            'label' => esc_html__('Border Line', 'bixos'),
            'section' => 'section_typo_navigation',
            'priority' => 27
        )
    )
