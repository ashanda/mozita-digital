...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
        ...
        array(
            'type'      => 'checkbox',
            'label'     => esc_html__('Partner Box ( OFF | ON )', 'bixos'),
...
$wp_customize->add_control(
    new themesflat_MultiImages(
        ...
        'img_partner',
        array(
           'label'          => esc_html__( 'Upload Your Partner Image', 'bixos' ),
           'type'           => 'multi-image',
           'section'        => 'section_partner_box',
           'priority'       => 2,
        )
...
$wp_customize->add_control(
    'show_number_img_partner_desktop',
    array(
       'label'          => esc_html__( 'Show Number Image (Desktop)', 'bixos' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 3,
    )
...
$wp_customize->add_control(
    'show_number_img_partner_tablet',
    array(
       'label'          => esc_html__( 'Show Number Image (Tablet)', 'bixos' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 4,
    )
...
$wp_customize->add_control(
    'show_number_img_partner_mobile',
    array(
       'label'          => esc_html__( 'Show Number Image (Mobile)', 'bixos' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 5,
    )    
...
$wp_customize->add_control(
    'gap_img_partner',
    array(
       'label'          => esc_html__( 'Gap Image', 'bixos' ),
       'type'           => 'number',
       'section'        => 'section_partner_box',
       'priority'       => 6,
    )
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'partner_box_controls',
    array(
        'label' => esc_html__( 'Partner Box Controls (px)', 'bixos' ),
        'section' => 'section_partner_box',
        'type' => 'box-controls',
        'priority' => 7,
    ))
...
$wp_customize->add_control( 
    new themesflat_ColorOverlay(
        ...
        'partner_box_background_color',
        array(
            'label'         => esc_html__('Partner Box Backgound', 'bixos'),
            'section'       => 'section_partner_box',
            'priority'      => 8
        )
    )
