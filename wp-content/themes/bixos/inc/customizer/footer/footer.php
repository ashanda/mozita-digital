...
$wp_customize->add_control(
    ...
    array(
        ...
        'priority'  => 1,
        'label'     => esc_html__('Columns Footer', 'bixos'),
        'choices'   => array(                
            1     => esc_html__( '1 Columns', 'bixos' ),
            2     => esc_html__( '2 Columns', 'bixos' ),
            3     => esc_html__( '3 Columns', 'bixos' ),
            4     => esc_html__( '4 Columns ( 5 | 2 | 2 | 3 )', 'bixos' ),
            5     => esc_html__( '4 Columns ( 3 | 3 | 3 | 3 )', 'bixos' ),                  
        )
    )
); 
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    'footer_controls',
    array(
        'label' => esc_html__( 'Footer Box Controls (px)', 'bixos' ),
        'section' => 'section_footer',
        'type' => 'box-controls',
        'priority' => 2
    ))
