...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'bixos' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'bixos' ),
				'200'        => esc_html__( 'Extra-light 200', 'bixos' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'bixos' ),
				'300'        => esc_html__( 'Light 300', 'bixos' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'bixos' ),
				'400'        => esc_html__( 'Normal 400', 'bixos' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'bixos' ),
				'regular'    => esc_html__( 'Normal 400', 'bixos' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'bixos' ),
				'500'        => esc_html__( 'Medium 500', 'bixos' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'bixos' ),
				'600'        => esc_html__( 'Semi-bold 600', 'bixos' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'bixos' ),
				'700'        => esc_html__( 'Bold 700', 'bixos' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'bixos' ),
				'800'        => esc_html__( 'Extra-bold 800', 'bixos' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'bixos' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'bixos' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'bixos' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'bixos'),
			    "greek" 		=> esc_html__("Greek",'bixos'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'bixos'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'bixos'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'bixos'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'bixos'),
			    "latin" 		=> esc_html__("Latin",'bixos')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'bixos' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php echo esc_attr( $name ) ?>[family]" id="<?php echo esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'bixos' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'bixos' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'bixos' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'bixos' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'bixos' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'bixos' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'bixos' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
