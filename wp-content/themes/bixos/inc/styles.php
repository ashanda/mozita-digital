...
function themesflat_custom_styles( $custom ) {
	...
	//GROUP HEADER
		...
		if ( $header_backgroundcolor !='' ) {
			$custom .= "#header.header-default, #header.header-1, #header.header-2 { background:" . esc_attr($header_backgroundcolor) . ";}"."\n";
		}
		...
		if ( $mainnav_hover_color !='' ) {
			$custom .= "#mainnav > ul > li:hover > a,#mainnav > ul > li.current-menu-item > a, #mainnav > ul > li.current-menu-ancestor > a, #mainnav > ul > li.current-menu-parent > a,#mainnav > ul > li:hover > a,#mainnav > ul > li.current-menu-item > a, #mainnav > ul > li.current-menu-ancestor > a, #mainnav > ul > li.current-menu-parent > a { color:" . esc_attr($mainnav_hover_color) . ";}"."\n";
			$custom .= "#mainnav > ul > li > a:after,#mainnav > ul > li.current-menu-item > a:after, #mainnav > ul > li.current-menu-ancestor > a:after, #mainnav > ul > li.current-menu-parent > a:after { background:" . esc_attr($mainnav_hover_color) . ";}"."\n";
		}
		...
		if ( $sub_nav_color_hover !='' ) {
			...
			$custom .= "#mainnav ul.sub-menu:after { background:" . esc_attr($sub_nav_color_hover) . ";}"."\n";
		}
	...
	//GROUP FOOTER
		...
		if ( $footer_text_color !='' ) {
			$custom .= "#footer, #footer input,#footer select,#footer textarea, #footer a, footer .widget.widget-recent-news li .text .post-date, footer .widget.widget_latest_news li .text .post-date, #footer .footer-widgets .widget.widget_themesflat_socials ul li a, footer select option, footer .widget.widget_recent_entries ul li .post-date, #footer .wp-block-latest-posts__post-author, #footer .wp-block-latest-posts__post-date,#footer .label-subcribe,#footer .content,#footer .wp-block-calendar tbody td { color:" . esc_attr($footer_text_color) . ";}"."\n";
		}

		$footer_text_color_hover = themesflat_get_opt( 'footer_text_color_hover');
		if ( $footer_text_color_hover !='' ) {
			$custom .= "#footer a:hover,#footer .footer-widgets .widget.widget_themesflat_socials ul li a:hover { color:" . esc_attr($footer_text_color_hover) . ";}"."\n";
			$custom .= "footer .widget.widget_nav_menu ul > li > a:before{ background:" . esc_attr($footer_text_color_hover) . ";}"."\n";
		}		
	...
	//GROUP COLOR
	    ...
	    if ( $primary_color !='' ) { 
	    	...
	    	$custom .= "article .entry-title a, .item article .entry-title a, .tags-links a, .logged-in-as a, blockquote em a,a { color:" . esc_attr($primary_color) . ";}"."\n";

	    	//Sidebar
	    	$custom .= ".comment-list .comement_reply a:hover, .sidebar .widget_recent_comments ul li, .sidebar .widget.widget_block ol.wp-block-latest-comments li, .sidebar .widget.widget_recent_comments ul li, .sidebar .widget.widget_rss ul li, .sidebar .widget.widget_block ol.wp-block-latest-comments li, .sidebar .wp-block-search .wp-block-search__label, .sidebar .wc-block-product-search .wc-block-product-search__label { color:" . esc_attr($primary_color) . "!important;}"."\n";

	    	$custom .= ".tf-posts .blog-post .tf-button:hover, .tf-posts .blog-post .title a { color:" . esc_attr($primary_color) . ";}"."\n";

	    	$custom .= "#commentform .wrap-input-submit:before, .themesflat-button:before, .wp-block-button__link:before, .draw-border a:before, button:before, .btn:before, input[type=\"button\"]:hover, input[type=\"reset\"]:hover, input[type=\"submit\"]:hover, .go-top { background-color:" . esc_attr($primary_color) . ";}"."\n";

			$custom .= "input[type='submit']:hover,.navigation.paging-navigation a.next:hover,.navigation.paging-navigation a.prev { background-color:" . esc_attr($primary_color) . " !important;}"."\n";

	    	$custom .= ".modal-menu__panel-body .search-form input[type=\"search\"]:focus,.navigation.paging-navigation a.next:hover,.navigation.paging-navigation a.prev { border-color:" . esc_attr($primary_color) . ";}"."\n";
    	...
    	if ( $secondary_color !='' ) {
		    ...
		    //svg
		    $custom .= ".info-header .icon-info svg{ fill:" . esc_attr($secondary_color) . ";}"."\n";
			...
			$custom .= '.blog-grid .blog-post:hover .featured-post .post-date::before, .blog-list .blog-post:hover .featured-post .post-date::before, .blog-single .featured-post .post-date::before,.single-portfolios .content .post-meta::before,.portfolios-post .content .post-meta::before { border-top-color:' . esc_attr($secondary_color) . " !important; }"."\n";
			$custom .= '.spin-load-1 { border-top-color:' . esc_attr($secondary_color) . " ; }"."\n";
    	...
    	if ( $accent_color !='' ) {
    		...
    		$custom .= '.blog-list .blog-post .featured-post .post-date, .blog-grid .blog-post .featured-post .post-date { background-color:' . esc_attr($accent_color) . " ;}"."\n";

			$custom .= ' .blog-grid .blog-post .featured-post .post-date::before, .blog-list .blog-post .featured-post .post-date::before  { border-top-color:' . esc_attr($accent_color) . "; }"."\n";
