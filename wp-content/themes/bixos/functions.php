...
function themesflat_setup() {
     ...
     * to change 'bixos' to the name of your theme in all the template files
     */
    load_theme_textdomain( 'bixos', THEMESFLAT_DIR . '/languages' );
    ...
    add_image_size( 'themesflat-blog', 1080, 1012, true );
    add_image_size( 'themesflat-blog-grid', 1480, 1000, true );    
    ...
    register_nav_menus( array(
        'primary' => esc_html__( 'Primary Menu', 'bixos' ),
        'bottom' => esc_html__( 'Bottom Menu', 'bixos' )
    ) );
...
function themesflat_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Blog', 'bixos' ),
        'id'            => 'blog-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Blog Sidebar.', 'bixos' ),
    ...
    //Widget footer
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 1', 'bixos' ),
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 1.', 'bixos' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 2', 'bixos' ),
        'id'            => 'footer-2',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 2.', 'bixos' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 3', 'bixos' ),
        'id'            => 'footer-3',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 3.', 'bixos' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 4', 'bixos' ),
        'id'            => 'footer-4',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer widget area 4.', 'bixos' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Toggler', 'bixos' ),
        'id'            => 'aside-toggler-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar toggler.', 'bixos' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Services Sidebar', 'bixos' ),
        'id'            => 'themesflat-custom-sidebar-servicessidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar services.', 'bixos' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Portfolio Sidebar', 'bixos' ),
        'id'            => 'themesflat-custom-sidebar-portfoliosidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar portfolio.', 'bixos' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
...
function themesflat_scripts() {    
    // Theme stylesheet.    
    wp_enqueue_style( 'flaticon', THEMESFLAT_LINK . 'css/flaticon.css' );
    wp_enqueue_style( 'icon-bixos', THEMESFLAT_LINK . 'css/icon-bixos.css' );
    ...
    wp_enqueue_style( 'magnific-popup', THEMESFLAT_LINK . 'css/magnific.popup.css' );   
