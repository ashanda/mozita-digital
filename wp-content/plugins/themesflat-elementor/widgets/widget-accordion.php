...
class TFAccordion_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Accordion', 'bixos' );
    }
	...
	protected function register_controls() {
        // Start Accordion        
			$this->start_controls_section( 
				'section_accordion',
	            [
	                'label' => esc_html__('Accordion', 'bixos'),
	            ]
	        );	
			...
			$this->add_control( 
				...
				[
					...
					'default' => 'icon_after',
					'options' => [
						'icon_before'  => esc_html__( 'Left', 'bixos' ),
						'icon_after' => esc_html__( 'Right', 'bixos' ),
						'icon_before_after' => esc_html__( 'Both side', 'bixos' ),
					],
					'condition' => [
						'icon_style!' => 'none',
					],
			...
			$this->add_control( 'icon_accodion',
				[
					'label' => esc_html__( 'Left Icon', 'bixos' ),
			...
			$this->add_control( 'image_accodion',
				[
					'label' => esc_html__( 'Left Icon Image', 'bixos' ),
			...
			$this->add_control( 'icon_accodion_active',
				[
					'label' => esc_html__( 'Left Icon Active', 'bixos' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_active',
				[
					'label' => esc_html__( 'Left Icon Image Active', 'bixos' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
			...
			$this->add_control( 'icon_accodion_right',
				[
					'label' => esc_html__( 'Right Icon', 'bixos' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_right',
				[
					'label' => esc_html__( 'Right Icon Image', 'bixos' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
			...
			$this->add_control( 'icon_accodion_right_active',
				[
					'label' => esc_html__( 'Right Icon Active', 'bixos' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_right_active',
				[
					'label' => esc_html__( 'Right Icon Image Active', 'bixos' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
	        ...
	        $repeater = new \Elementor\Repeater();
	        	$repeater->add_control( 'set_active',
					[
						'label' => esc_html__( 'Set Active Item', 'bixos' ),
		        ...
		        $repeater->add_control( 'list_title', [
						...
						'default' => esc_html__( 'Accordion' , 'bixos' ),
						'label_block' => true,
					]
				);
				...
				$repeater->add_control( 'list_content', [
						...
						'default' => esc_html__( 'Good strategy is the antidote to competition. Strategic thinking is the process of developing a strategy that defines your value proposition and your unique value chain. This process includes market and competitive research as well as an assessment of the company’s capabilities and the industry forces impacting it.' , 'bixos' ),
						'label_block' => true,
						'condition' => [
		        ...
		        $this->add_control( 'accordion_list',
					[					
						...
						'default' => [
							[	
								'set_active' => 'active',
								'list_title' => esc_html__( 'What is the standard size of business cards?', 'bixos' ),
								'list_content' => esc_html__( "Nullam felis sapien, pellentesque sit amet finibus ac, semper at lacus. Vestibulum nisi eros, molestie auctor suscipit consectetur, tempor vitae lacus. Duis purus dui." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( 'What should be listed on a business card?', 'bixos' ),
								'list_content' => esc_html__( "Nullam felis sapien, pellentesque sit amet finibus ac, semper at lacus. Vestibulum nisi eros, molestie auctor suscipit consectetur, tempor vitae lacus. Duis purus dui." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( 'How do I design my own business cards?', 'bixos' ),
								'list_content' => esc_html__( "Nullam felis sapien, pellentesque sit amet finibus ac, semper at lacus. Vestibulum nisi eros, molestie auctor suscipit consectetur, tempor vitae lacus. Duis purus dui." ),
							],
						],
        ...
        // Start Icon Style 
	        ...
	        $this->add_responsive_control(
				'icon_size_w',
				[
					'label' => esc_html__( 'Icon Size Width', 'bixos' ),
			...
			$this->add_responsive_control(
				'icon_size_h',
				[
					'label' => esc_html__( 'Icon Size Height', 'bixos' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px', '%' ],
					'range' => [
						'px' => [
	        ...
	        $this->add_control(
				'heading_icon_left',
				[
					'label' => esc_html__( 'Icon Left', 'bixos' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'icon_position' => ['icon_before', 'icon_before_after'],
			...
			$this->add_responsive_control(
				'icon_font_size',
				[
					'label' => esc_html__( 'Icon Font Size', 'bixos' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
			...
			$this->add_control(
				'heading_icon_right',
				[
					'label' => esc_html__( 'Icon Right', 'bixos' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'icon_position' => ['icon_after', 'icon_before_after'],
	    ...
	    // Start Title Style 
			...
			$this->start_controls_tabs( 
				...
				$this->add_control( 'title_line',
					[
						'label' => esc_html__( 'Line', 'bixos' ),
						'type' => \Elementor\Controls_Manager::SELECT,
						'default' => 'no_line',
						'options' => [
							'no-line'  => esc_html__( 'No', 'bixos' ),
							'yes-line'  => esc_html__( 'Yes', 'bixos' ),
						],	
					]
				);	   
				...
				$this->add_control( 'title_line_color',
					[
						'label' => esc_html__( 'Color Line', 'bixos' ),
						'type' => \Elementor\Controls_Manager::COLOR,
						'default' => '#0000331a',
						'selectors' => [
							'{{WRAPPER}} .tf-accordion.yes-line .accordion-title::after' => 'background-color: {{VALUE}}',
						],
					]
				);

				$this->add_control( 'title_line_color_active',
				[
					'label' => esc_html__( 'Color Line Active', 'bixos' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'default' => '#000033',
					'selectors' => [
						'{{WRAPPER}} .tf-accordion.yes-line .accordion-title.active::after' => 'background-color: {{VALUE}}',
					],
				]
			);
	...
	protected function render($instance = []) {
		...
		foreach ($settings['accordion_list'] as $key => $value) {
			...
			if ( $settings['icon_style'] == 'icon' ) {
				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_close =  \Elementor\Addon_Elementor_Icon_manager_Bixos::render_icon( $settings['icon_accodion'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_close =  \Elementor\Addon_Elementor_Icon_manager_Bixos::render_icon( $settings['icon_accodion_right'] );
				}

				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_open =  \Elementor\Addon_Elementor_Icon_manager_Bixos::render_icon( $settings['icon_accodion_active'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_open =  \Elementor\Addon_Elementor_Icon_manager_Bixos::render_icon( $settings['icon_accodion_right_active'] );
				}
		...
		echo sprintf ( 
            ...
            $accordion_item,$settings['title_line']
        );
	}	
