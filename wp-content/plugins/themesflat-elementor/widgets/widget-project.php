...
class TFproject_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Project', 'bixos' );
    }
	...
	protected function register_controls() {
        // Start Posts Query        
			...
			$this->add_control( 
				...
				[
					...
					'options' => ThemesFlat_Addon_For_Elementor_Bixos::tf_get_taxonomies('project_category'),
					'label_block' => true,
	                'multiple' => true,
				]
			);
			...
			$this->add_control( 
				...
				[
					'label' => esc_html__( 'Filter Order', 'bixos' ),
					'type'	=> \Elementor\Controls_Manager::TEXT,	
					'description' => esc_html__( 'Filter Slug Categories Order Split By ","', 'bixos' ),
					'default' => '',
					'label_block' => true,	
					'condition' => [
						'show_filter' => 'yes',
			...
			$this->add_control( 
				'filter_color_hover',
				[
					'label' => esc_html__( 'Color Hover & Active', 'bixos' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		...
		// Start Style
			...
			$this->add_control( 
				'btn_bgcolor_hover',
				[
					'label' => esc_html__( ' Background Hover', 'bixos' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
