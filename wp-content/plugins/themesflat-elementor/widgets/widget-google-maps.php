...
class TF_Google_Maps_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TF Google Maps', 'bixos' );
	}
	...
	protected function register_controls() {
				...
				$this->add_control(
					...
					[
						...
						'raw' => sprintf(
							...
							esc_html__( 'Set your Google Maps API Key in Elementor\'s <a href="%1$s" target="_blank">Integrations Settings</a> page. Create your key <a href="%2$s" target="_blank">here.', 'bixos' ),
		...
		$default_address = esc_html__( '121 King St, Melbourne VIC 3000, Australia', 'bixos' );
		$this->add_control(
			'address',
			[
				'label' => esc_html__( 'Location', 'bixos' ),
		...
		$this->add_control(
			'hover_transition',
			[
				'label' => esc_html__( 'Transition Duration', 'bixos' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 3,
