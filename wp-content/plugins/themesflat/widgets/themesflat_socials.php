...
class themesflat_socials extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__( 'Themesflat - Socials', 'bixos' ),
            array(
                'classname'   => 'widget_themesflat_socials',
                'description' => esc_html__( 'Themesflat Socials.', 'bixos' )
            )
        );
    }
    ...
    function themesflat_available_social_icons_widget() {
        $icons = apply_filters( 'themesflat_available_icons', array(
            'facebook'       => array( 'iclass' => 'bixos-icon-facebook', 'title' => 'Facebook' ),
            'twitter'        => array( 'iclass' => 'bixos-icon-twitter', 'title' => 'Twitter' ),
            ...
            'vimeo'          => array( 'iclass' => 'fab fa-vimeo-v', 'title' => 'Vimeo' ),
            'linkedin'       => array( 'iclass' => 'bixos-icon-linkedin', 'title' => 'LinkedIn' ),
